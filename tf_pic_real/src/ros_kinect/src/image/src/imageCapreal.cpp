...
void image_socket(Mat inImg)
{
    ...
    rectangle(inImg, Point(inImg.cols/2-objWidth/2-4,inImg.rows/2-objHeight/2-4),Point(inImg.cols/2+objWidth/2+2,inImg.rows/2+objHeight/2+2),Scalar(0,0,255), 3, 8 );
     //画矩形
    ...
    switch(c)
    {
      ...
      strs="/home/exbot/tensor/try_real/src/real_num/";
      sss.clear();
      sss<<strs;
      //sss<<image_num;
      sss<<"test.png";
      ...
      cout<<"test images have saved!"<<endl;
      //image_num++;
      exit(0);
      break;
  default:
...
int main(int argc, char **argv)
{
    ...
    ROS_INFO("-------Please enter 'P' get image!---------");
